namespace GaussDB.EntityFrameworkCore.PostgreSQL.Metadata;
...
/// <summary>
///     Extension methods over <see cref="GaussDBValueGenerationStrategy" />.
/// </summary>
public static class GaussDBValueGenerationStrategyExtensions
{
    /// <summary>
    ///     Whether the given strategy is either <see cref="GaussDBValueGenerationStrategy.IdentityByDefaultColumn" /> or
    ///     <see cref="GaussDBValueGenerationStrategy.IdentityAlwaysColumn" />.
    /// </summary>
    public static bool IsIdentity(this GaussDBValueGenerationStrategy strategy)
        => strategy is GaussDBValueGenerationStrategy.IdentityByDefaultColumn or GaussDBValueGenerationStrategy.IdentityAlwaysColumn;
