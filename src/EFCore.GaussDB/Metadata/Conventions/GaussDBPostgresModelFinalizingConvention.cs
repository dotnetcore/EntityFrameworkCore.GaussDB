...
/// </remarks>
public class GaussDBPostgresModelFinalizingConvention : IModelFinalizingConvention
{
    private readonly IRelationalTypeMappingSource _typeMappingSource;

    /// <summary>
    ///     Creates a new instance of <see cref="GaussDBPostgresModelFinalizingConvention" />.
    /// </summary>
    /// <param name="typeMappingSource">The type mapping source to use.</param>
    public GaussDBPostgresModelFinalizingConvention(IRelationalTypeMappingSource typeMappingSource)
    {
