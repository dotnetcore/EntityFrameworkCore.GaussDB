...
/// <summary>
///     The default query SQL generator for GaussDB.
/// </summary>
public class GaussDBQuerySqlGenerator : QuerySqlGenerator
{
    ...
    /// <inheritdoc />
    public GaussDBQuerySqlGenerator(
    ...
    protected override string GetOperator(SqlBinaryExpression e)
        => e.OperatorType switch
        {
            ...
            ExpressionType.Add when
                ...
                || e.Type == typeof(GaussDBTsVector)
                || e.Left.TypeMapping?.ClrType == typeof(GaussDBTsVector)
                || e.Right.TypeMapping?.ClrType == typeof(GaussDBTsVector)
                || e.Left.TypeMapping is GaussDBArrayTypeMapping && e.Right.TypeMapping is GaussDBArrayTypeMapping
                => " || ",
            ...
            .Append(
                binaryExpression.OperatorType switch
                {
                    PgExpressionType.Contains
                        when binaryExpression.Left.TypeMapping is GaussDBInetTypeMapping or GaussDBCidrTypeMapping
                        => ">>",
                    ...
                    PgExpressionType.LTreeMatches
                        ...
                        || binaryExpression.Right.TypeMapping is GaussDBArrayTypeMapping { ElementTypeMapping.StoreType: "lquery" } => "~",
                    PgExpressionType.LTreeMatches
    ...
    protected override Expression VisitSqlUnary(SqlUnaryExpression sqlUnaryExpression)
    {
        ...
        switch (sqlUnaryExpression.OperatorType)
        {
            ...
            case ExpressionType.Not when sqlUnaryExpression.Operand.TypeMapping.ClrType == typeof(GaussDBTsQuery):
                Sql.Append("!!");
                Visit(sqlUnaryExpression.Operand);
                return sqlUnaryExpression;
    ...
    protected override Expression VisitJsonScalar(JsonScalarExpression jsonScalarExpression)
    {
        ...
        switch (jsonScalarExpression.TypeMapping)
        {
            ...
            case GaussDBOwnedJsonTypeMapping:
            ...
            case GaussDBArrayTypeMapping arrayMapping:
