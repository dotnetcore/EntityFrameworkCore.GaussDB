...
/// </summary>
public class GaussDBBigIntegerMemberTranslator : IMemberTranslator
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public GaussDBBigIntegerMemberTranslator(GaussDBSqlExpressionFactory sqlExpressionFactory)
    {
