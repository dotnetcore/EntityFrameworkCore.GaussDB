...
/// </summary>
public class GaussDBLTreeTranslator : IMethodCallTranslator, IMemberTranslator
{
    ...
    // If it's a parameter, we can also just apply the mapping (which causes GaussDBDbType to be set to LQuery).
