...
/// </remarks>
public class GaussDBStringMethodTranslator : IMethodCallTranslator
{
    ...
    /// </summary>
    public GaussDBStringMethodTranslator(GaussDBTypeMappingSource typeMappingSource, ISqlExpressionFactory sqlExpressionFactory)
    {
        ...
        IDiagnosticsLogger<DbLoggerCategory.Query> logger)
    {
        ...
        if (method.DeclaringType == typeof(GaussDBDbFunctionsExtensions))
        {
    ...
    private SqlExpression? TranslateStringMethod(SqlExpression? instance, MethodInfo method, IReadOnlyList<SqlExpression> arguments)
    {
        ...
        if (method.DeclaringType == typeof(string)
            ...
            && arguments[1].TypeMapping is GaussDBArrayTypeMapping)
        {
