...
/// <summary>
///     GaussDB-specific extension methods for <see cref="EntityTypeBuilder" />.
/// </summary>
/// <remarks>
///     See <see href="https://aka.ms/efcore-docs-modeling">Modeling entity types and relationships</see>.
/// </remarks>
public static class GaussDBEntityTypeBuilderExtensions
{
    ...
    public static EntityTypeBuilder<TEntity> HasGeneratedTsVectorColumn<TEntity>(
        ...
        Expression<Func<TEntity, GaussDBTsVector>> tsVectorPropertyExpression,
        string config,
    ...
    /// <summary>
    ///     Configures the entity to use an unlogged table when targeting GaussDB.
    /// </summary>
    /// <param name="entityTypeBuilder">The builder for the entity type being configured.</param>
    ...
    /// <summary>
    ///     Configures the mapped table to use an unlogged table when targeting GaussDB.
    /// </summary>
    /// <param name="entityTypeBuilder">The builder for the entity type being configured.</param>
    /// <param name="unlogged">True to configure the entity to use an unlogged table; otherwise, false.</param>
    /// <returns>
    ...
    /// <summary>
    ///     Returns a value indicating whether the mapped table can be configured to use an unlogged table when targeting GaussDB.
    /// </summary>
    /// <param name="entityTypeBuilder">The builder for the entity type being configured.</param>
    /// <param name="unlogged">True to configure the entity to use an unlogged table; otherwise, false.</param>
    /// <param name="fromDataAnnotation"> Indicates whether the configuration was specified using a data annotation. </param>
        ...
        bool fromDataAnnotation = false)
    {
        ...
        return entityTypeBuilder.CanSetAnnotation(GaussDBAnnotationNames.UnloggedTable, unlogged, fromDataAnnotation);
    }
    ...
    /// <returns>The same builder instance so that multiple calls can be chained.</returns>
    /// <remarks>
    ///     See <see href="https://www.GaussDB.org/efcore/modeling/concurrency.html">Concurrency tokens</see>
    ...
    /// </summary>
    /// <remarks>
    ///     See http://www.GaussDB.org/efcore/miscellaneous.html#optimistic-concurrency-and-concurrency-tokens
    /// </remarks>
    /// <param name="entityTypeBuilder">The builder for the entity type being configured.</param>
    /// <returns>The same builder instance so that multiple calls can be chained.</returns>
    [Obsolete("Use EF Core's standard IsRowVersion() or [Timestamp], see https://learn.microsoft.com/ef/core/saving/concurrency")]
