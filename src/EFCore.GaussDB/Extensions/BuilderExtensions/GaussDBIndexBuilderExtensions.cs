...
using GaussDB.EntityFrameworkCore.PostgreSQL.Utilities;

// ReSharper disable once CheckNamespace
namespace Microsoft.EntityFrameworkCore;

/// <summary>
///     GaussDB specific extension methods for <see cref="IndexBuilder" />.
/// </summary>
public static class GaussDBIndexBuilderExtensions
{
    #region Method
        ...
        bool fromDataAnnotation = false)
    {
        ...
        return indexBuilder.CanSetAnnotation(GaussDBAnnotationNames.IndexMethod, method, fromDataAnnotation);
    }
        ...
        bool fromDataAnnotation)
    {
        ...
        return indexBuilder.CanSetAnnotation(GaussDBAnnotationNames.IndexOperators, operators, fromDataAnnotation);
    }
        ...
        bool fromDataAnnotation = false)
    {
        ...
        return indexBuilder.CanSetAnnotation(GaussDBAnnotationNames.TsVectorConfig, config, fromDataAnnotation);
    }
        ...
        bool fromDataAnnotation)
    {
        ...
        return indexBuilder.CanSetAnnotation(GaussDBAnnotationNames.IndexNullSortOrder, values, fromDataAnnotation);
    }
        ...
        bool fromDataAnnotation = false)
    {
        ...
        return indexBuilder.CanSetAnnotation(GaussDBAnnotationNames.CreatedConcurrently, createdConcurrently, fromDataAnnotation);
    }
        ...
        bool fromDataAnnotation = false)
    {
        ...
        return indexBuilder.CanSetAnnotation(GaussDBAnnotationNames.NullsDistinct, nullsDistinct, fromDataAnnotation);
    }
        ...
        bool fromDataAnnotation = false)
    {
        ...
        return indexBuilder.CanSetAnnotation(
            GaussDBAnnotationNames.StorageParameterPrefix + parameterName, parameterValue, fromDataAnnotation);
    }
        ...
        bool fromDataAnnotation)
    {
        ...
        return indexBuilder.CanSetAnnotation(GaussDBAnnotationNames.IndexSortOrder, values, fromDataAnnotation);
    }
