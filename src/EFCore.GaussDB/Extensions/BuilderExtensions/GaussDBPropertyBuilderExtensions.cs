...
/// <summary>
///     GaussDB specific extension methods for <see cref="PropertyBuilder" />.
/// </summary>
public static class GaussDBPropertyBuilderExtensions
{
    #region HiLo
        ...
        string? schema = null)
    {
        ...
        name ??= GaussDBModelExtensions.DefaultHiLoSequenceName;
        ...
        bool fromDataAnnotation = false)
    {
        ...
        return propertyBuilder.CanSetAnnotation(GaussDBAnnotationNames.HiLoSequenceName, name, fromDataAnnotation)
            && propertyBuilder.CanSetAnnotation(GaussDBAnnotationNames.HiLoSequenceSchema, schema, fromDataAnnotation);
    }
        ...
        string? schema = null)
    {
        ...
        property.SetValueGenerationStrategy(GaussDBValueGenerationStrategy.Sequence);
    ...
    ///     <see href="https://aka.ms/efcore-docs-GaussDB">Accessing SQL Server and SQL Azure databases with EF Core</see>
        ...
        bool fromDataAnnotation = false)
    {
        ...
        return propertyBuilder.CanSetAnnotation(GaussDBAnnotationNames.SequenceName, name, fromDataAnnotation)
            && propertyBuilder.CanSetAnnotation(GaussDBAnnotationNames.SequenceSchema, schema, fromDataAnnotation);
    }
        ...
        this PropertyBuilder propertyBuilder)
    {
        ...
        var property = propertyBuilder.Metadata;
        property.SetValueGenerationStrategy(GaussDBValueGenerationStrategy.SerialColumn);
        property.SetSequenceName(null);
        property.SetSequenceSchema(null);
    ...
    public static PropertyBuilder UseIdentityAlwaysColumn(this PropertyBuilder propertyBuilder)
    {
        ...
        var property = propertyBuilder.Metadata;
        property.SetValueGenerationStrategy(GaussDBValueGenerationStrategy.IdentityAlwaysColumn);
        property.SetHiLoSequenceName(null);
        property.SetHiLoSequenceSchema(null);
        property.SetSequenceName(null);
        property.SetSequenceSchema(null);
    ...
    public static PropertyBuilder UseIdentityByDefaultColumn(this PropertyBuilder propertyBuilder)
    {
        ...
        var property = propertyBuilder.Metadata;
        property.SetValueGenerationStrategy(GaussDBValueGenerationStrategy.IdentityByDefaultColumn);
        property.SetHiLoSequenceName(null);
        property.SetHiLoSequenceSchema(null);
        property.SetSequenceName(null);
        property.SetSequenceSchema(null);
    ...
    public static IConventionPropertyBuilder? HasValueGenerationStrategy(
        this IConventionPropertyBuilder propertyBuilder,
        GaussDBValueGenerationStrategy? valueGenerationStrategy,
        bool fromDataAnnotation = false)
    {
        if (propertyBuilder.CanSetAnnotation(
                GaussDBAnnotationNames.ValueGenerationStrategy, valueGenerationStrategy, fromDataAnnotation))
        {
            propertyBuilder.Metadata.SetValueGenerationStrategy(valueGenerationStrategy, fromDataAnnotation);

            if (valueGenerationStrategy != GaussDBValueGenerationStrategy.SequenceHiLo)
            {
                propertyBuilder.HasHiLoSequence(null, null, fromDataAnnotation);
            }

            if (valueGenerationStrategy != GaussDBValueGenerationStrategy.Sequence)
            {
        ...
        bool fromDataAnnotation = false)
    {
        ...
        return (valueGenerationStrategy is null
                || GaussDBPropertyExtensions.IsCompatibleWithValueGeneration(propertyBuilder.Metadata))
        ...
        long? numbersToCache = null)
    {
        ...
        return propertyBuilder.CanSetAnnotation(GaussDBAnnotationNames.IdentityOptions, value);
    }
    ...
    /// </summary>
    [Obsolete(
        "HasPostgresArrayConversion has been replaced with the standard EF 8 primitive collection API, see https://www.GaussDB.org/efcore/release-notes/8.0.html",
        error: true)]
    ...
    /// <param name="includedPropertyNames">An array of property names to be included in the tsvector.</param>
    /// <returns>A builder to further configure the property.</returns>
    public static PropertyBuilder<GaussDBTsVector> IsGeneratedTsVectorColumn(
        this PropertyBuilder<GaussDBTsVector> propertyBuilder,
        string config,
        params string[] includedPropertyNames)
        => (PropertyBuilder<GaussDBTsVector>)IsGeneratedTsVectorColumn((PropertyBuilder)propertyBuilder, config, includedPropertyNames);
        ...
        bool fromDataAnnotation = false)
    {
        ...
        return propertyBuilder.CanSetAnnotation(GaussDBAnnotationNames.CompressionMethod, compressionMethod, fromDataAnnotation);
    }
