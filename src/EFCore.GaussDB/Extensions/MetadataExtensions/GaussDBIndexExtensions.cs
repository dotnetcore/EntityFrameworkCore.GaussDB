...
#pragma warning restore 618
    ...
    public static IReadOnlyList<SortOrder>? GetSortOrder(this IReadOnlyIndex index)
        => (IReadOnlyList<SortOrder>?)index[GaussDBAnnotationNames.IndexSortOrder];
    ...
    public static void SetSortOrder(this IMutableIndex index, IReadOnlyList<SortOrder>? sortOrder)
        => index.SetOrRemoveAnnotation(GaussDBAnnotationNames.IndexSortOrder, sortOrder);
        ...
        bool fromDataAnnotation = false)
    {
        ...
        index.SetOrRemoveAnnotation(GaussDBAnnotationNames.IndexSortOrder, sortOrder, fromDataAnnotation);
    ...
    public static ConfigurationSource? GetSortOrderConfigurationSource(this IConventionIndex index)
        => index.FindAnnotation(GaussDBAnnotationNames.IndexSortOrder)?.GetConfigurationSource();
