...
public static class GaussDBModelExtensions
{
    ...
    public static string? GetDefaultColumnCollation(this IReadOnlyModel model)
        => (string?)model[GaussDBAnnotationNames.DefaultColumnCollation];
    ...
    public static void SetDefaultColumnCollation(this IMutableModel model, string? collation)
        => model.SetOrRemoveAnnotation(GaussDBAnnotationNames.DefaultColumnCollation, collation);
    ...
    {
        model.SetOrRemoveAnnotation(GaussDBAnnotationNames.DefaultColumnCollation, collation, fromDataAnnotation);
        return collation;
    }
    ...
    public static ConfigurationSource? GetDefaultColumnCollationConfigurationSource(this IConventionModel model)
        => model.FindAnnotation(GaussDBAnnotationNames.DefaultColumnCollation)?.GetConfigurationSource();
