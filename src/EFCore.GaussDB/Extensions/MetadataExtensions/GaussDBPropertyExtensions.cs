...
public static class GaussDBPropertyExtensions
{
    ...
    public static GaussDBValueGenerationStrategy? SetValueGenerationStrategy(
        ...
        GaussDBValueGenerationStrategy? value,
        bool fromDataAnnotation = false)
        => (GaussDBValueGenerationStrategy?)property.SetOrRemoveAnnotation(
            GaussDBAnnotationNames.ValueGenerationStrategy, value, fromDataAnnotation)?.Value;
    ...
    public static GaussDBValueGenerationStrategy? SetValueGenerationStrategy(
        ...
        GaussDBValueGenerationStrategy? value,
        bool fromDataAnnotation = false)
        => (GaussDBValueGenerationStrategy?)overrides.SetOrRemoveAnnotation(
            GaussDBAnnotationNames.ValueGenerationStrategy, value, fromDataAnnotation)?.Value;
