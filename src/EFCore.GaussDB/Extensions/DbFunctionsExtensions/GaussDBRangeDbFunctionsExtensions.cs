...
/// <summary>
///     Provides extension methods for <see cref="GaussDBRange{T}" /> supporting PostgreSQL translation.
/// </summary>
public static class GaussDBRangeDbFunctionsExtensions
{
    /// <summary>
    ...
    /// </exception>
    public static bool Contains<T>(this GaussDBRange<T> range, T value)
    ...
    ///     query.
    /// </exception>
    public static bool Contains<T>(this GaussDBRange<T> a, GaussDBRange<T> b)
        => throw new InvalidOperationException(CoreStrings.FunctionOnClient(nameof(Contains)));
    ...
    /// </exception>
    public static bool ContainedBy<T>(this GaussDBRange<T> a, GaussDBRange<T> b)
    ...
    /// </exception>
    public static bool Overlaps<T>(this GaussDBRange<T> a, GaussDBRange<T> b)
    ...
    /// </exception>
    public static bool IsStrictlyLeftOf<T>(this GaussDBRange<T> a, GaussDBRange<T> b)
    ...
    /// </exception>
    public static bool IsStrictlyRightOf<T>(this GaussDBRange<T> a, GaussDBRange<T> b)
    ...
    /// </exception>
    public static bool DoesNotExtendLeftOf<T>(this GaussDBRange<T> a, GaussDBRange<T> b)
    ...
    /// </exception>
    public static bool DoesNotExtendRightOf<T>(this GaussDBRange<T> a, GaussDBRange<T> b)
    ...
    /// </exception>
    public static bool IsAdjacentTo<T>(this GaussDBRange<T> a, GaussDBRange<T> b)
    ...
    /// </exception>
    public static GaussDBRange<T> Union<T>(this GaussDBRange<T> a, GaussDBRange<T> b)
    ...
    /// </exception>
    public static GaussDBRange<T> Intersect<T>(this GaussDBRange<T> a, GaussDBRange<T> b)
    ...
    /// </exception>
    public static GaussDBRange<T> Except<T>(this GaussDBRange<T> a, GaussDBRange<T> b)
    ...
    /// </exception>
    public static GaussDBRange<T> Merge<T>(this GaussDBRange<T> a, GaussDBRange<T> b)
    ...
    /// </exception>
    public static GaussDBRange<T>[] RangeAgg<T>(this IEnumerable<GaussDBRange<T>> input)
    ...
    /// <seealso href="https://www.postgresql.org/docs/current/functions-aggregate.html">PostgreSQL documentation for aggregate functions.</seealso>
    /// <exception cref="NotSupportedException">
    ///     <see cref="RangeIntersectAgg{T}(IEnumerable{GaussDBRange{T}})" /> is only intended for use via SQL translation as part of an EF Core
    ///     LINQ query.
    /// </exception>
    public static GaussDBRange<T> RangeIntersectAgg<T>(this IEnumerable<GaussDBRange<T>> input)
