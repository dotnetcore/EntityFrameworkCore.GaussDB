...
public static class GaussDBFullTextSearchDbFunctionsExtensions
{
    /// <summary>
    ...
    /// </remarks>
    public static GaussDBTsVector ArrayToTsVector(this DbFunctions _, string[] lexemes)
    ...
    /// </remarks>
    public static GaussDBTsVector ToTsVector(this DbFunctions _, string document)
    ...
    ///     http://www.postgresql.org/docs/current/static/textsearch-controls.html#TEXTSEARCH-PARSING-DOCUMENTS
    /// </remarks>
    public static GaussDBTsVector ToTsVector(this DbFunctions _, [NotParameterized] string config, string document)
        => throw new InvalidOperationException(CoreStrings.FunctionOnClient(nameof(ToTsVector)));
    ...
    /// </remarks>
    public static GaussDBTsQuery PlainToTsQuery(this DbFunctions _, string query)
    ...
    ///     http://www.postgresql.org/docs/current/static/textsearch-controls.html#TEXTSEARCH-PARSING-QUERIES
    /// </remarks>
    public static GaussDBTsQuery PlainToTsQuery(this DbFunctions _, [NotParameterized] string config, string query)
        => throw new InvalidOperationException(CoreStrings.FunctionOnClient(nameof(PlainToTsQuery)));
    ...
    ///     http://www.postgresql.org/docs/current/static/textsearch-controls.html#TEXTSEARCH-PARSING-QUERIES
    /// </remarks>
    public static GaussDBTsQuery PhraseToTsQuery(this DbFunctions _, string query)
    ...
    ///     http://www.postgresql.org/docs/current/static/textsearch-controls.html#TEXTSEARCH-PARSING-QUERIES
    /// </remarks>
    public static GaussDBTsQuery PhraseToTsQuery(this DbFunctions _, [NotParameterized] string config, string query)
        => throw new InvalidOperationException(CoreStrings.FunctionOnClient(nameof(PhraseToTsQuery)));
    ...
    ///     http://www.postgresql.org/docs/current/static/textsearch-controls.html#TEXTSEARCH-PARSING-QUERIES
    /// </remarks>
    public static GaussDBTsQuery ToTsQuery(this DbFunctions _, string query)
    ...
    ///     http://www.postgresql.org/docs/current/static/textsearch-controls.html#TEXTSEARCH-PARSING-QUERIES
    /// </remarks>
    public static GaussDBTsQuery ToTsQuery(this DbFunctions _, [NotParameterized] string config, string query)
        => throw new InvalidOperationException(CoreStrings.FunctionOnClient(nameof(ToTsQuery)));
    ...
    ///     http://www.postgresql.org/docs/current/static/textsearch-controls.html#TEXTSEARCH-PARSING-QUERIES
    /// </remarks>
    public static GaussDBTsQuery WebSearchToTsQuery(this DbFunctions _, string query)
    ...
    ///     http://www.postgresql.org/docs/current/static/textsearch-controls.html#TEXTSEARCH-PARSING-QUERIES
    /// </remarks>
    public static GaussDBTsQuery WebSearchToTsQuery(this DbFunctions _, [NotParameterized] string config, string query)
        => throw new InvalidOperationException(CoreStrings.FunctionOnClient(nameof(WebSearchToTsQuery)));
