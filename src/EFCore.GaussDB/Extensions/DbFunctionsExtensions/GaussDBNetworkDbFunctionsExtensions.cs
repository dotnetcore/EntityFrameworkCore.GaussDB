...
/// </remarks>
public static class GaussDBNetworkDbFunctionsExtensions
{
    #region RelationalOperators

    /// <summary>
    ///     Determines whether an <see cref="GaussDBInet" /> is less than another <see cref="GaussDBInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The left-hand inet.</param>
    /// <param name="other">The right-hand inet.</param>
    /// <returns>
    ///     True if the <see cref="GaussDBInet" /> is less than the other <see cref="GaussDBInet" />; otherwise, false.
    /// </returns>
    /// <exception cref="NotSupportedException">
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static bool LessThan(this DbFunctions _, GaussDBInet inet, GaussDBInet other)
    ...
    /// <summary>
    ///     Determines whether an <see cref="GaussDBInet" /> is less than or equal to another <see cref="GaussDBInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The left-hand inet.</param>
    /// <param name="other">The right-hand inet.</param>
    /// <returns>
    ///     True if the <see cref="GaussDBInet" /> is less than or equal to the other <see cref="GaussDBInet" />; otherwise, false.
    /// </returns>
    /// <exception cref="NotSupportedException">
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static bool LessThanOrEqual(this DbFunctions _, GaussDBInet inet, GaussDBInet other)
    ...
    /// <summary>
    ///     Determines whether an <see cref="GaussDBInet" /> is greater than or equal to another <see cref="GaussDBInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The left-hand inet.</param>
    /// <param name="other">The right-hand inet.</param>
    /// <returns>
    ///     True if the <see cref="GaussDBInet" /> is greater than or equal to the other <see cref="GaussDBInet" />; otherwise, false.
    /// </returns>
    /// <exception cref="NotSupportedException">
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static bool GreaterThanOrEqual(this DbFunctions _, GaussDBInet inet, GaussDBInet other)
    ...
    /// <summary>
    ///     Determines whether an <see cref="GaussDBInet" /> is greater than another <see cref="GaussDBInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The left-hand inet.</param>
    /// <param name="other">The right-hand inet.</param>
    /// <returns>
    ///     True if the <see cref="GaussDBInet" /> is greater than the other <see cref="GaussDBInet" />; otherwise, false.
    /// </returns>
    /// <exception cref="NotSupportedException">
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static bool GreaterThan(this DbFunctions _, GaussDBInet inet, GaussDBInet other)
    ...
    /// <summary>
    ///     Determines whether an <see cref="GaussDBInet" /> is contained within another <see cref="GaussDBInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The inet to locate.</param>
    /// <param name="other">The inet to search.</param>
    /// <returns>
    ///     True if the <see cref="GaussDBInet" /> is contained within the other <see cref="GaussDBInet" />; otherwise, false.
    /// </returns>
    /// <exception cref="NotSupportedException">
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static bool ContainedBy(this DbFunctions _, GaussDBInet inet, GaussDBInet other)
        => throw new InvalidOperationException(CoreStrings.FunctionOnClient(nameof(ContainedBy)));

    /// <summary>
    ///     Determines whether an <see cref="GaussDBInet" /> is contained within or equal to another <see cref="GaussDBInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The inet to locate.</param>
    /// <param name="other">The inet to search.</param>
    /// <returns>
    ///     True if the <see cref="GaussDBInet" /> is contained within or equal to the other <see cref="GaussDBInet" />; otherwise, false.
    /// </returns>
    /// <exception cref="NotSupportedException">
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static bool ContainedByOrEqual(this DbFunctions _, GaussDBInet inet, GaussDBInet other)
        => throw new InvalidOperationException(CoreStrings.FunctionOnClient(nameof(ContainedByOrEqual)));

    /// <summary>
    ///     Determines whether an <see cref="GaussDBInet" /> contains another <see cref="GaussDBInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The IP address to search.</param>
    /// <param name="other">The IP address to locate.</param>
    /// <returns>
    ///     True if the <see cref="GaussDBInet" /> contains the other <see cref="GaussDBInet" />; otherwise, false.
    /// </returns>
    /// <exception cref="NotSupportedException">
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static bool Contains(this DbFunctions _, GaussDBInet inet, GaussDBInet other)
        => throw new InvalidOperationException(CoreStrings.FunctionOnClient(nameof(Contains)));

    /// <summary>
    ///     Determines whether an <see cref="GaussDBInet" /> contains or is equal to another <see cref="GaussDBInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The IP address to search.</param>
    /// <param name="other">The IP address to locate.</param>
    /// <returns>
    ///     True if the <see cref="GaussDBInet" /> contains or is equal to the other <see cref="GaussDBInet" />; otherwise, false.
    /// </returns>
    /// <exception cref="NotSupportedException">
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static bool ContainsOrEqual(this DbFunctions _, GaussDBInet inet, GaussDBInet other)
        => throw new InvalidOperationException(CoreStrings.FunctionOnClient(nameof(ContainsOrEqual)));

    /// <summary>
    ///     Determines whether an <see cref="GaussDBInet" /> contains or is contained by another <see cref="GaussDBInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The IP address to search.</param>
    /// <param name="other">The IP address to locate.</param>
    /// <returns>
    ///     True if the <see cref="GaussDBInet" /> contains or is contained by the other <see cref="GaussDBInet" />; otherwise, false.
    /// </returns>
    /// <exception cref="NotSupportedException">
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static bool ContainsOrContainedBy(this DbFunctions _, GaussDBInet inet, GaussDBInet other)
    ...
    /// <summary>
    ///     Computes the bitwise NOT operation on an <see cref="GaussDBInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static GaussDBInet BitwiseNot(this DbFunctions _, GaussDBInet inet)
    ...
    /// <summary>
    ///     Computes the bitwise AND of two <see cref="GaussDBInet" /> instances.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The left-hand inet.</param>
    /// <param name="other">The right-hand inet.</param>
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static GaussDBInet BitwiseAnd(this DbFunctions _, GaussDBInet inet, GaussDBInet other)
    ...
    /// <summary>
    ///     Computes the bitwise OR of two <see cref="GaussDBInet" /> instances.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The left-hand inet.</param>
    /// <param name="other">The right-hand inet.</param>
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static GaussDBInet BitwiseOr(this DbFunctions _, GaussDBInet inet, GaussDBInet other)
    ...
    /// <summary>
    ///     Adds the <paramref name="value" /> to the <see cref="GaussDBInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The inet.</param>
    /// <param name="value">The value to add.</param>
    /// <returns>
    ///     The <see cref="GaussDBInet" /> augmented by the <paramref name="value" />.
    /// </returns>
    /// <exception cref="NotSupportedException">
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static GaussDBInet Add(this DbFunctions _, GaussDBInet inet, int value)
        => throw new InvalidOperationException(CoreStrings.FunctionOnClient(nameof(Add)));

    /// <summary>
    ///     Subtracts the <paramref name="value" /> from the <see cref="GaussDBInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    /// <param name="inet">The inet.</param>
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static GaussDBInet Subtract(this DbFunctions _, GaussDBInet inet, long value)
        => throw new InvalidOperationException(CoreStrings.FunctionOnClient(nameof(Subtract)));

    /// <summary>
    ///     Subtracts one <see cref="GaussDBInet" /> from another <see cref="GaussDBInet" />.
    /// </summary>
    /// <param name="_">The <see cref="DbFunctions" /> instance.</param>
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static int Subtract(this DbFunctions _, GaussDBInet inet, GaussDBInet other)
        => throw new InvalidOperationException(CoreStrings.FunctionOnClient(nameof(Subtract)));
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static string Abbreviate(this DbFunctions _, GaussDBInet inet)
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static GaussDBInet Broadcast(this DbFunctions _, GaussDBInet inet)
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static int Family(this DbFunctions _, GaussDBInet inet)
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static string Host(this DbFunctions _, GaussDBInet inet)
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static GaussDBInet HostMask(this DbFunctions _, GaussDBInet inet)
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static int MaskLength(this DbFunctions _, GaussDBInet inet)
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static GaussDBInet Netmask(this DbFunctions _, GaussDBInet inet)
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static GaussDBCidr Network(this DbFunctions _, GaussDBInet inet)
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static GaussDBInet SetMaskLength(this DbFunctions _, GaussDBInet inet, int length)
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static string Text(this DbFunctions _, GaussDBInet inet)
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static bool SameFamily(this DbFunctions _, GaussDBInet inet, GaussDBInet other)
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    public static GaussDBCidr Merge(this DbFunctions _, GaussDBInet inet, GaussDBInet other)
    ...
    ///     This method is only intended for use via SQL translation as part of an EF Core LINQ query.
    /// </exception>
    [Obsolete("Use the overload which accepts GaussDBCidr", error: true)]
