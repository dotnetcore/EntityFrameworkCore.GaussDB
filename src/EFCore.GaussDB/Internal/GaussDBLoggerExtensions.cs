...
/// </summary>
public static class GaussDBLoggerExtensions
{
    /// <summary>
    ///     This is an internal API that supports the Entity Framework Core infrastructure and not subject to
    ///     the same compatibility standards as public APIs. It may be changed or removed without notice in
    ...
    public static void MissingSchemaWarning(
        ...
        string? schemaName)
    {
        var definition = GaussDBResources.LogMissingSchema(diagnostics);
    ...
    public static void MissingTableWarning(
        ...
        string? tableName)
    {
        var definition = GaussDBResources.LogMissingTable(diagnostics);
    ...
    {
        var definition = GaussDBResources.LogPrincipalTableNotInSelectionSet(diagnostics);
    ...
    {
        var definition = GaussDBResources.LogFoundColumn(diagnostics);
    ...
    public static void CollationFound(
        ...
        bool deterministic)
    {
        var definition = GaussDBResources.LogFoundCollation(diagnostics);
    ...
    public static void UniqueConstraintFound(
        ...
        string tableName)
    {
        var definition = GaussDBResources.LogFoundUniqueConstraint(diagnostics);
    ...
    public static void EnumColumnSkippedWarning(
        ...
        string columnName)
    {
        var definition = GaussDBResources.LogEnumColumnSkipped(diagnostics);
    ...
    public static void ExpressionIndexSkippedWarning(
        ...
        string tableName)
    {
        var definition = GaussDBResources.LogExpressionIndexSkipped(diagnostics);
    ...
    public static void UnsupportedColumnIndexSkippedWarning(
        ...
        string tableName)
    {
        var definition = GaussDBResources.LogUnsupportedColumnIndexSkipped(diagnostics);
    ...
    public static void UnsupportedColumnConstraintSkippedWarning(
        ...
        string tableName)
    {
        var definition = GaussDBResources.LogUnsupportedColumnConstraintSkipped(diagnostics);
