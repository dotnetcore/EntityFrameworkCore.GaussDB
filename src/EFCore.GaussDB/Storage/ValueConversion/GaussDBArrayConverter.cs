...
namespace GaussDB.EntityFrameworkCore.PostgreSQL.Storage.ValueConversion;
...
/// </summary>
public class GaussDBArrayConverter<TModelCollection, TConcreteModelCollection, TProviderCollection>
    ...
    where TProviderCollection : IEnumerable
{
    ...
    /// <summary>
    ///     Constructs a new instance of <see cref="GaussDBArrayConverter{TModel, TConcreteModel, TProvider}" />.
    /// </summary>
    public GaussDBArrayConverter()
    ...
    ///     Constructs a new instance of <see cref="GaussDBArrayConverter{TModel, TConcreteModel, TProvider}" />.
    /// </summary>
    public GaussDBArrayConverter(ValueConverter? elementConverter)
        : base(
