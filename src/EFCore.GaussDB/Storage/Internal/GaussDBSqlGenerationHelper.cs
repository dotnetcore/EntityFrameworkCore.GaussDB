...
/// </summary>
public class GaussDBSqlGenerationHelper : RelationalSqlGenerationHelper
{
    private static readonly HashSet<string> ReservedWords;

    static GaussDBSqlGenerationHelper()
    {
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public GaussDBSqlGenerationHelper(RelationalSqlGenerationHelperDependencies dependencies)
        : base(dependencies)
    {
    }
