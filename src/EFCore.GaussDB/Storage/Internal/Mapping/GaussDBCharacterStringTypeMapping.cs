...
/// </remarks>
/// <inheritdoc />
public class GaussDBCharacterStringTypeMapping : GaussDBStringTypeMapping
{
    /// <summary>
    ...
    /// </summary>
    public static new GaussDBCharacterStringTypeMapping Default { get; } = new("text");
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public GaussDBCharacterStringTypeMapping(string storeType, int size = 1)
        : this(
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    protected GaussDBCharacterStringTypeMapping(RelationalTypeMappingParameters parameters)
        : base(parameters, GaussDBDbType.Char)
    {
    }
    ...
    protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
        => new GaussDBCharacterStringTypeMapping(
            new RelationalTypeMappingParameters(
