...
/// </summary>
public class GaussDBBigIntegerTypeMapping : GaussDBTypeMapping
{
    /// <summary>
    ///     This is an internal API that supports the Entity Framework Core infrastructure and not subject to
    ///     the same compatibility standards as public APIs. It may be changed or removed without notice in
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public static GaussDBBigIntegerTypeMapping Default { get; } = new();
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public GaussDBBigIntegerTypeMapping()
        : base("numeric", typeof(BigInteger), GaussDBDbType.Numeric, jsonValueReaderWriter: JsonBigIntegerReaderWriter.Instance)
    {
    }
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    protected GaussDBBigIntegerTypeMapping(RelationalTypeMappingParameters parameters)
        : base(parameters, GaussDBDbType.Numeric)
    {
    }
    ...
    protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
        => new GaussDBBigIntegerTypeMapping(parameters);
