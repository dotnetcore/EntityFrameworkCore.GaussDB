...
/// </summary>
public class GaussDBIntervalTypeMapping : GaussDBTypeMapping
{
    /// <summary>
    ///     This is an internal API that supports the Entity Framework Core infrastructure and not subject to
    ///     the same compatibility standards as public APIs. It may be changed or removed without notice in
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public static GaussDBIntervalTypeMapping Default { get; } = new();
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public GaussDBIntervalTypeMapping()
        : this(
            new RelationalTypeMappingParameters(
                new CoreTypeMappingParameters(typeof(TimeSpan), jsonValueReaderWriter: GaussDBJsonTimeSpanReaderWriter.Instance),
                "interval"))
    {
    }
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    protected GaussDBIntervalTypeMapping(RelationalTypeMappingParameters parameters)
    ...
    protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
        => new GaussDBIntervalTypeMapping(parameters);
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public sealed class GaussDBJsonTimeSpanReaderWriter : JsonValueReaderWriter<TimeSpan>
    {
        private static readonly PropertyInfo InstanceProperty = typeof(GaussDBJsonTimeSpanReaderWriter).GetProperty(nameof(Instance))!;
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public static GaussDBJsonTimeSpanReaderWriter Instance { get; } = new();
