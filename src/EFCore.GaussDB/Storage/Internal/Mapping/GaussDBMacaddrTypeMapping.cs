...
/// </remarks>
public class GaussDBMacaddrTypeMapping : GaussDBTypeMapping
{
    /// <summary>
    ...
    /// </summary>
    public static GaussDBMacaddrTypeMapping Default { get; } = new();
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public GaussDBMacaddrTypeMapping()
        : base("macaddr", typeof(PhysicalAddress), GaussDBDbType.MacAddr, jsonValueReaderWriter: JsonMacaddrReaderWriter.Instance)
    {
    }
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    protected GaussDBMacaddrTypeMapping(RelationalTypeMappingParameters parameters)
        : base(parameters, GaussDBDbType.MacAddr)
    {
    }
    ...
    protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
        => new GaussDBMacaddrTypeMapping(parameters);
