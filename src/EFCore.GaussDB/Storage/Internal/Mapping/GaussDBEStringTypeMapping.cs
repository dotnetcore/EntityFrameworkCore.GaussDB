...
///     This is a "virtual" type mapping which is never returned by <see cref="GaussDBTypeMappingSource" />.
...
/// </remarks>
public class GaussDBEStringTypeMapping : StringTypeMapping
{
    /// <summary>
    ...
    /// </summary>
    public new static GaussDBEStringTypeMapping Default { get; } = new();
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public GaussDBEStringTypeMapping()
