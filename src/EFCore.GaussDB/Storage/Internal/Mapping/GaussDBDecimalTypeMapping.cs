...
/// </summary>
public class GaussDBDecimalTypeMapping : GaussDBTypeMapping
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public static GaussDBDecimalTypeMapping Default { get; } = new();
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public GaussDBDecimalTypeMapping(Type? clrType = null)
        : this(
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    protected GaussDBDecimalTypeMapping(RelationalTypeMappingParameters parameters)
    ...
    protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
        => new GaussDBDecimalTypeMapping(parameters);
