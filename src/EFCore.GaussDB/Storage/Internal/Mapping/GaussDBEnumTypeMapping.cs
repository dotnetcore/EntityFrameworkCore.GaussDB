...
/// </summary>
public class GaussDBEnumTypeMapping : RelationalTypeMapping
{
    /// <summary>
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public static GaussDBEnumTypeMapping Default { get; } = new();
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual IGaussDBNameTranslator NameTranslator { get; }
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public GaussDBEnumTypeMapping(string storeType, Type enumType, IGaussDBNameTranslator? nameTranslator = null)
        : base(
            storeType,
            enumType,
...
#pragma warning restore CS0618
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    protected GaussDBEnumTypeMapping(
    ...
    private GaussDBEnumTypeMapping()
...
#pragma warning restore CS0618
    ...
    protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
        => new GaussDBEnumTypeMapping(parameters, NameTranslator);
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    private static Dictionary<object, string> CreateValueMapping(Type enumType, IGaussDBNameTranslator nameTranslator)
