...
/// </remarks>
public class GaussDBHstoreTypeMapping : GaussDBTypeMapping
{
    ...
    /// </summary>
    public static GaussDBHstoreTypeMapping Default { get; } = new(typeof(Dictionary<string, string>));
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public GaussDBHstoreTypeMapping(Type clrType)
        : base(
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    protected GaussDBHstoreTypeMapping(RelationalTypeMappingParameters parameters)
        : base(parameters, GaussDBDbType.Hstore)
    {
    }
    ...
    protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
        => new GaussDBHstoreTypeMapping(parameters);
