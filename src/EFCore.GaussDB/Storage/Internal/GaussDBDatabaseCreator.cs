...
""");
    ...
    public override async Task DeleteAsync(CancellationToken cancellationToken = default)
    {
        ...
        {
            case GaussDBDataSource dataSource:
                // TODO: Do this asynchronously once https://github.com/GaussDB/GaussDB/issues/4499 is done
                dataSource.Clear();
                break;
            case null:
                ClearAllPools();
    ...
    public override void CreateTables()
    {
        ...
        if (reloadTypes && connection.DbConnection is GaussDBConnection GaussDBConnection)
        {
