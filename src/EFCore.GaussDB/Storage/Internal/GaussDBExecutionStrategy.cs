...
/// </summary>
public class GaussDBExecutionStrategy : IExecutionStrategy
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public GaussDBExecutionStrategy(ExecutionStrategyDependencies dependencies)
    {
        ...
        Func<DbContext, TState, ExecutionResult<TResult>>? verifySucceeded)
    {
        ...
        catch (Exception ex) when (ExecutionStrategy.CallOnWrappedException(ex, GaussDBTransientExceptionDetector.ShouldRetryOn))
        {
