...
/// </summary>
public class GaussDBHistoryRepository : HistoryRepository, IHistoryRepository
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public GaussDBHistoryRepository(HistoryRepositoryDependencies dependencies)
        : base(dependencies)
    {
    }
    ...
    public override IMigrationsDatabaseLock AcquireDatabaseLock()
    {
        ...
        return new GaussDBMigrationDatabaseLock(this);
    }
    ...
    private IModel EnsureModel()
    {
        if (_model == null)
        {
            ...
            conventionSet.Remove(typeof(GaussDBPostgresModelFinalizingConvention));
...
""";
    ...
    private sealed class GaussDBMigrationDatabaseLock(IHistoryRepository historyRepository) : IMigrationsDatabaseLock
    {
        /// <summary>
        ///     This is an internal API that supports the Entity Framework Core infrastructure and not subject to
        ///     the same compatibility standards as public APIs. It may be changed or removed without notice in
